...
renderTabList = () => {
    ...
    style={{color: '#f1faee', backgroundColor:'#6A30FE' }}
		>
		Complete
			</span>
		<span
...
renderItems = () => {
    ...
    style={{backgroundColor:'#bfc0c0', color:'#f1faee'}}
	>
		<span
		...
		<button
			...
			className="btn mr-2"
      style={{backgroundColor:'#FB89CC', color:'#f1faee'}}
		>
			Edit
		</button>
		<button
			...
			className="btn"
      style={{backgroundColor:'#E16BE6', color:'#f1faee'}}
		>
			Delete
		</button>
		</span>
...
render() {
	...
	<main className="content">
		<h1 className="text-uppercase text-center my-4" style={{color:'#9381ff'}}>
		Django-React Task Manager
		</h1>
		<div className="row ">
		<div className="col-md-6 col-sm-10 mx-auto p-0">
			<div className="card p-3" style={{backgroundColor: '#27272B'}}>
			<div className="">
				<button onClick={this.createItem} className="btn" style={{backgroundColor:'#4cc9f0', color:'#f1faee'}}>
				Add Task
				</button>
			</div>
			{this.renderTabList()}
